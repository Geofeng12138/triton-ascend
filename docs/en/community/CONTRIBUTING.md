...
- Refactoring Guidelines
  ...
  We encourage developers to refactor our code to eliminate [code smells]. Refactored code should also follow the coding style and test style requirements. When you receive warnings, you need to refactor the code to be merged.

<h2 id="fork-pull-development-model">Fork-Pull Development Model</h2>

1. Fork the Triton Ascend Project

   Before submitting your own code to the Triton Ascend project, ensure you have forked the Triton Ascend project to your own repository. You will subsequently develop on your forked project and merge changes into the Triton Ascend project via Pull Requests. This means there is parallel development between the Triton Ascend repository and your own repository, so please ensure consistency between them.
...
- If you resolve an issue you reported yourself, let others know before closing the issue.
...
- Only proceed with fork development and submit a PR after consensus is reached on the issue discussion and design proposal review.
- No PR is allowed until 2+ LGTM (Looks Good To Me) are received from Approvers. Please note that reviewers are not allowed to add LGTM to their own PRs.
