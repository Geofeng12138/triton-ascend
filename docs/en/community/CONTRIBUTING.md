...
- Read the [README.md](https://github.com/triton-lang/triton-ascend/blob/main/README.md) for project information and setting up the development environment.
...
- Static Check Failure
  ...
  Please find the exception information in the code based on the prompt information and resolve it.
...
A good way to contribute to the project is by sending detailed reports when encountering problems. We always greatly appreciate well-written, thorough bug reports and will be very grateful for them!
...
- If you solve an issue you reported yourself, let others know before closing it.
...
- Only proceed with forking, development, and submitting a PR after reaching a consensus through issue discussion and design proposal review.
- No PR is allowed until it receives 2+ LGTM (Looks Good To Me) from Approvers. Please note that reviewers are not allowed to add LGTM to their own PRs.
