...
| Type                             | Linux Maximum Permission Reference |
|----------------------------------|------------------------------------|
...
Triton-Ascend supports source code compilation and installation. During compilation, it will download dependent third-party libraries and execute build shell scripts. Temporary program files and compilation directories will be generated during the build process. Users can manage permissions on files within the source code directory as needed to reduce security risks.
