...
| `lhs_k_pack`   | `(bool, optional)` | true packs along K dimension<br>false packs along M dimension<br>    |
| `rhs_k_pack`   | `(bool, optional)` | true packs along K dimension<br>false packs along N dimension<br>    |
...
2. The scale tensor values are int8 on Ascend and uint8 on GPU.
