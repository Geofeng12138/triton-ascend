...
| `max_num_imprecise_acc` | `int`               | Number of imprecise accumulations (currently Ascend does not support imprecise accumulation).                                       |
...
- `acc` cannot support `fp16`; for precision, the hardware defaults to `fp32`.
