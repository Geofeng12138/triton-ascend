...
|-----------|------|---------|-------------|
| `prefix` | `str` | Required | Prefix string before printing values |
...
**Note**: The `prefix` string prefix must be included when using `device_print`, otherwise it will cause a compilation error.
