...
| `tie_break_left` | `bool` | If multiple elements have the same maximum value, return the index of the leftmost maximum value |
...
For the case of tensor[nan,inf], the index of inf is returned.