...
| [max](./max.md) | Returns the maximum value of all elements in the input tensor along the specified axis |
| [min](./min.md) | Returns the minimum value of all elements in the input tensor along the specified axis |
