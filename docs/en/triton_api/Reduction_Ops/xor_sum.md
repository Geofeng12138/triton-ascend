...
> `keep_dims=True` requires more testing specifications to determine full support. Currently, it has been tested that `keep_dims=True` is supported for 3D with `dim=2`.
