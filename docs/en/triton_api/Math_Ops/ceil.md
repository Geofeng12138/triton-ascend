...
Ascend lacks fp64 support compared to GPU, but adds support for fp16, bf16, and integer inputs.

### 2.4 Usage Example

The following example demonstrates computing the ceiling of the input tensor `x`:
