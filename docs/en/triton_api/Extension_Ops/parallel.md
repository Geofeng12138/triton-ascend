...
When `bind_sub_block` is true, the difference from `range` is reflected in the IR. Whether the functionality is actually implemented is pending verification.
