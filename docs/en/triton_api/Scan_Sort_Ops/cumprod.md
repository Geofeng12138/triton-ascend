...
| `axis` | `int` | The dimension along which to compute the cumulative product, default is 0 |
| `reverse` | `bool` | If True, computes the cumulative product in the reverse direction |
