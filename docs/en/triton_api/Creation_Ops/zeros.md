...
Description: `triton.language.zeros` returns a tensor filled with the scalar value 0, given the shape and dtype.
...
Return value:
`tensor`: Returns a tensor filled with the scalar value 0, given the shape and dtype.
