...
Description: Performs a right bitwise shift on a tensor according to a given value.
...
| :---: | :---: | --- |
| `input` | `tensor` | Tensor data, the left operand, representing the main data to be shifted |
...
The following example performs a right shift operation on three-dimensional tensors `x0` and `x1`:
