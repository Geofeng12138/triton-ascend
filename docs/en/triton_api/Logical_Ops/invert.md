...
Description: Performs a bitwise inversion on each value of the tensor.
...
The following example demonstrates performing an element-wise bitwise NOT operation on the input tensor `x`:
