...
| ---------- | ------------------------------------------------------------------------------------- | -------- |
| `sem`      | Community officially accepted values are "acquire", "release", "acq_rel" (default, representing "ACQUIRE_RELEASE"), and "relaxed".<br>We only support "acq_rel". | To be developed |
| `scope`    | Accepted values are "gpu", "cta", or "sys".<br>We only support "gpu".                 | To be developed |
