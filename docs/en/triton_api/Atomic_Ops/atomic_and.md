...
Introduction: Atomic AND operation, performs a logical AND at the specified memory location.
Prototype:
...
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| `sem`            | Officially accepted values in the community are "acquire", "release", "acq_rel" (default, representing "ACQUIRE_RELEASE"), and "relaxed".<br>We only support "acq_rel". | Pending development |
