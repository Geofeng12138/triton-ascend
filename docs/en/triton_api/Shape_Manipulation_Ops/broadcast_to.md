...
Broadcasts a tensor to a target shape, automatically handling dimension alignment. The broadcast operation does not copy data; instead, it achieves the effect by modifying the tensor's shape and strides.
