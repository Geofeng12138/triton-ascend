...
Reorders the dimensions of a tensor according to the `dims` parameter. It does not change the tensor's data, only the order of the dimensions. Supports reordering of any number of dimensions.
