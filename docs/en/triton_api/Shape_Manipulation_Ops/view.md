...
Creates a view of a tensor, changing its shape without copying data. Similar to `reshape`, but with a stronger emphasis on the view concept, maintaining data contiguity in memory.
...
- Similar to `reshape`, but with a stronger emphasis on the view concept
