...
The following example selects element-wise based on the condition `X < Y`: takes the element of `X` when the condition is true, otherwise takes the constant `1`.
