...
Description: **Converts the indices of a row-major matrix of size size_i × size_j, grouped by every size_g rows, into indices of a column-major matrix.**
...
| ------------ | -------- | ------------------------------------------------------------------- |
| `i`          | `tensor` | Index value, maximum value is size_i - 1                            |
| `j`          | `tensor` | Index value, maximum value is size_j - 1                            |
...
The following example converts the indices of a row-major matrix, grouped by every `size_g` rows, into indices of a column-major matrix:
