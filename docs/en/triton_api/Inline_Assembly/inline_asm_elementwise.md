...
Ascend lacks support for uint8, uint16, uint32, uint64, fp16, fp64, bf16, and bool input tensor types compared to GPU.
...
3. Currently only supports 1D input tensors; higher-dimensional tensors must be flattened for computation.